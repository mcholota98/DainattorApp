...
public class see_detect {
    ...
    protected void onResolved(){ ;
        try{
            this.txtnumEvidencia.setText(unaEvidencia.getString("custodiado__persona__nombres")+" - "+unaEvidencia.getString("expresion_facial")+" - Registration date: "+unaEvidencia.getString("fecha_hora"));
